                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('role.role.update',$role)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$role['title']}}" name="title" class="form-control" id="exampleInputEmail1"
                                       placeholder="请输入角色中文名称">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">角色英文表示</label>
                                <input type="text" value="{{$role['name']}}" name="name" class="form-control" id="exampleInputEmail1" placeholder="请输入角色英文表示">
                            </div>
