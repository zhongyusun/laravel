                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <ul class="nav nav-tabs nav-overflow header-tabs">
                                    <li class="nav-item">
                                        <a href="{{route('member.my_like',[$user,'type'=>'article'])}}" class="nav-link active">
                                            文章
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('member.my_like',[$user,'type'=>'comments'])}}" class="nav-link">
                                            评论
                                        </a>
                                    </li>
                                </ul>
                                                    ...
                                                    <div class="col ml--2">
                                                        ...
                                                        <p class="card-text small mb-1">
                                                            ...
                                                            <a href="http://www.houdunren.com/edu/topics_1.html" class="text-secondary ml-2">
                                                                ...
                                                                {{$like->belongsModel->category->title}}
                                                            </a>
                                                        </p>
