<div id="rule" class="card">
    <div class="card-body">
        <div class="form-group">
            <label for="exampleInputEmail1">规则名称</label>
            <input type="text" v-model="rule.name" id="exampleInputEmail1" placeholder="" class="form-control">
        </div>
        <div class="card">
            <div class="card-body">
    ...
    <div class="card-footer">
        <button type="button" @click="add" class="btn btn-white">添加关键词</button>
    </div>
    <textarea hidden="hidden" name="rule" id="" cols="30" rows="10">@{{ rule }}</textarea>
</div>
